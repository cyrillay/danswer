      ...
      {notionCredential ? (
        ...
        <>
          <Text>
            ...
            Notion for TailorAI. Follow the instructions in the&nbsp;
            <a
            ...
            Notion docs to allow TailorAI to read Notion Databases and Pages
            ...
            <CredentialForm<NotionCredentialJson>
              ...
              validationSchema={Yup.object().shape({
                notion_integration_token: Yup.string().required(
                  "Please enter the Notion Integration token for the TailorAI integration."
                ),
              })}
              initialValues={{
