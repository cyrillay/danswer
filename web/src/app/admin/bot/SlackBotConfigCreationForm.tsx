          ...
          {({ isSubmitting, values }) => (
            <Form>
              <div className="px-6 pb-6">
                ...
                <SectionHeader>When should TailorAIBot respond?</SectionHeader>
                ...
                <BooleanFormField
                  ...
                  label="Respond to @TailorAIBot Only"
                  subtext="If set, TailorAIBot will only respond when directly tagged"
                />
                <BooleanFormField
                  name="respond_to_bots"
                  label="Responds to Bot messages"
                  subtext="If not set, TailorAIBot will always ignore messages from Bots"
                />
                <TextArrayField
                  name="respond_team_member_list"
                  label="Team Members Emails"
                  subtext={`If specified, TailorAIBot responses will only be
                  visible to members in this list. This is
                  useful if you want TailorAIBot to operate in an
                  "assistant" mode, where it helps the team members find
                  answers, but let's them build on top of TailorAIBot's response / throw
                ...
                <BooleanFormField
                  ...
                  label="Should TailorAI give a “Still need help?” button?"
                  subtext={`If specified, TailorAIBot's response will include a button at the bottom
                  ...
                  <TextArrayField
                    ...
                    subtext={
                      <div>
                        ...
                        handle. For example, &apos;TailorAI Team&apos; or
                        &apos;danswer-team&apos;.
                        <br />
                        <br />
                  ...
                  <Text>
                    <ul className="list-disc mt-2 ml-4">
                      ...
                      <li>
                        ...
                        which documents TailorAIBot uses as references.
                      </li>
                    </ul>
                  </Text>
                  <Text className="mt-2">
                      ...
                      <FieldArray
                        ...
                        render={(arrayHelpers: ArrayHelpers) => (
                          <div>
                            <div>
                              <SubLabel>
                                The document sets that TailorAIBot should search
                                through. If left blank, TailorAIBot will search
