    ...
    <div className="mb-8">
      ...
      <Text className="mb-2">
        <ul className="list-disc mt-2 ml-4">
          <li>
            Setup TailorAIBot to automatically answer questions in certain
            channels.
          </li>
          <li>
            Choose which document sets TailorAIBot should answer from, depending
            on the channel the question is being asked.
          </li>
          <li>
            Directly message TailorAIBot to search just as you would in the web
            UI.
          </li>
        </ul>
      </Text>
      ...
      <Text className="mb-6">
        ...
        found in the TailorAI documentation to get started!
      </Text>
      ...
      {slackBotTokens && (
        <>
          <Title className="mb-2 mt-4">Step 2: Setup TailorAIBot</Title>
          <Text className="mb-3">
            Configure TailorAI to automatically answer questions in Slack
            channels. By default, TailorAI only responds in channels where a
